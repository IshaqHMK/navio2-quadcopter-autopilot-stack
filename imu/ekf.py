...
from orientation import ecompass
from orientation import acc2q
from mathfuncs import cosd
from mathfuncs import sind
from mathfuncs import skew

from core import _assert_numerical_iterable
from core import _assert_numerical_positive_variable
...
class EKF:
    ...
    def _set_reference_frames(self, mref: float, frame: str = 'NED') -> None:
        ...
        if mref is None:
            ...
            from constants import MUNICH_LATITUDE, MUNICH_LONGITUDE, MUNICH_HEIGHT
            from wmm import WMM
