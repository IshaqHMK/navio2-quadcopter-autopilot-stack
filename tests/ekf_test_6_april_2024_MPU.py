...
class CustomEKF:
    def __init__(self, q0=None):
        ...
        gyroNoiseVar = 8e-5 #1e-2 # 1e-5 for best rol pitch
        biasNoiseVar = 1e-10
...
if __name__ == '__main__':
    ...
    for i in range(num_samples):
        ...
        print(f"Time: {i*Ts:.2f}s | EKF: Roll {np.rad2deg(phi):.2f}°, Pitch {np.rad2deg(theta):.2f}°, Yaw {np.rad2deg(psi):.2f}°")
    ...
    save_path = f"/home/pi/Documents/Quadcopter_Control_v2/data/results/ekf_results_mpu_001_{timestamp}.mat"
