...
and external integration for roll, pitch, yaw. Minimal changes from your script.
Finaized Version
"""
...
Ts = 0.005  # 100 Hz
windowSize = 200 # int(1/Ts)  # This converts the float to an integer.
...
if __name__ == '__main__':
    # 1) Setup IMUs, calibrate, etc. (same as your code)
    ...
    for i in range(num_main):
        ...
        (acc_comp, gyro_aligned, _,  # ignoring mag
         phi_acc, theta_acc,
         phi_gyr, theta_gyr, psi_gyr) = read_dual_imu_data_raw(
        ...
        # Overwrite the integrated angles with the fused roll/pitch
        # so next iteration uses them
        phi_gyro   = phi_comp
