...
total_simulation_time = 600 #200 # Simulation time in seconds  
...
def main():
    ...
    for i in range(num_samples):
        ...
        U4, J_hat_psi, B_hat_psi, d_hat_psi = adaptive_psi_control.update(
        ...
        _, _, U4 = rate_PID(p_desired, q_desired, r_desired, p_meas, q_meas, r_meas, P_KP, P_KI, P_KD, Q_KP, Q_KI, Q_KD, R_KP, R_KI, R_KD, Ts, PQR_PID_Enable)
        U4 = 0   
        U3 = 0   
    ...
    save_to_matfile(storage, gains, path_prefix='/home/pi/Documents/Quadcopter_Control_v2/data/results/quad_AC_')
