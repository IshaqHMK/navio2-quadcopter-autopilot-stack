...
# Note: copied from version 29
# adaptive controller for phi ONLY
...
total_simulation_time = 200 #200 # Simulation time in seconds  
...
def main():
    ...
    adaptive_phi_control  = AdaptiveAttitudeController(lmbda=3,
                                        gamma1=1,
                                        gamma2=1,
                                        gamma3=1,
                                        K=1,
    ...
    adaptive_theta_control  = AdaptiveAttitudeController(lmbda=3,
                                        gamma1=1,
                                        gamma2=1,
                                        gamma3=1,
                                        K=1,
    ...
    adaptive_psi_control  = AdaptiveAttitudeController(lmbda=1,
                                        gamma1=1,
                                        gamma2=1,
                                        gamma3=1,
                                        K=1,
