...
def main():
    ...
    #Phi_KP, Phi_KI, Phi_KD = 3, 3, 5
    #Theta_KP, Theta_KI, Theta_KD = 3, 3, 6

    Phi_KP, Phi_KI, Phi_KD = 6, 1, 4 # 
    Theta_KP, Theta_KI, Theta_KD = 4, 1 , 4
    Psi_KP, Psi_KI, Psi_KD = 5, 3, 4

    Phi_KP, Phi_KI, Phi_KD = 3, 1, 4 # 
    Theta_KP, Theta_KI, Theta_KD = 3, 1 , 4
    Psi_KP, Psi_KI, Psi_KD = 3, 1, 4

    Phi_KP, Phi_KI, Phi_KD = 4.229735075817941, 1.824489017857050, 3.211842902863446
    Theta_KP, Theta_KI, Theta_KD =5.021672078465006, 2.026496774841795, 3.013434240239965
    Psi_KP, Psi_KI, Psi_KD = 4.994860373573687, 2.069943130531200, 3.106117082846308

    # yaw is casuing problem
    Phi_KP, Phi_KI, Phi_KD = 4.229735075817941, 1.824489017857050, 3.211842902863446

    Theta_KP, Theta_KI, Theta_KD =5.054176070041542, 2.440842622881349, 3.227959230453821
    Psi_KP, Psi_KI, Psi_KD =5.002131330478567, 2.023871627202763, 3.228121310310987


    Psi_KP, Psi_KI, Psi_KD =20.000069561200107, 4.024663522144834, 2.499099276633733
    Psi_KP, Psi_KI, Psi_KD = 19.999900051261438, 4.023484370743829, 2.506248349350036

    Psi_KP, Psi_KI, Psi_KD = 19.999813736595378, 4.023225570028944, 2.515395490232227

    Psi_KP, Psi_KI, Psi_KD = 20.012539351376663, 4.021138590290899, 2.378723676476598

    Theta_KP, Theta_KI, Theta_KD = 5, 2.5, 5
    Theta_KP, Theta_KI, Theta_KD = 5.001434545665028, 2.495363736766358, 4.997621258885848
    Theta_KP, Theta_KI, Theta_KD = 4.995966334719393, 2.498940104020154, 5.000621201118602

    Theta_KP, Theta_KI, Theta_KD = 5.010029201089112, 2.520848109886752, 4.975279075004943





    Phi_KP, Phi_KI, Phi_KD = 4.370648399096253, 3.177833342544199, 3.502815611081499
    Theta_KP, Theta_KI, Theta_KD = 4.910269207233326, 2.359280225008894, 5.374829111725812
    ...
    Phi_KP, Phi_KI, Phi_KD =  4.214702823597207, 3.512944225183565, 2.862191024114487



    # manually tuned
    Phi_KP, Phi_KI, Phi_KD = 4.099399669874642, 3.619053279046704, 2.677567853055387
    Theta_KP, Theta_KI, Theta_KD =6.927721675485137, 2.165421634352503, 5.486940012863505
    Psi_KP, Psi_KI, Psi_KD =20.013761726562002, 4.775408973844076, 1.815894898809337


    Phi_KP, Phi_KI, Phi_KD = 4, 1, 2
    Theta_KP, Theta_KI, Theta_KD = 4, 1, 5
    Psi_KP, Psi_KI, Psi_KD = 10, 4.775408973844076, 1.815894898809337

    Phi_KP, Phi_KI, Phi_KD = 4.3, 0.5, 3.75
    Theta_KP, Theta_KI, Theta_KD = 5, 0.5, 4.1
    Psi_KP, Psi_KI, Psi_KD = 15, 1, 0.5

    Phi_KP, Phi_KI, Phi_KD = 4.010675630006054, 1.743140548883378, 3.759712999408786
    Theta_KP, Theta_KI, Theta_KD = 4.664234150252378, 2.013347532596310, 3.946754584205580
    Psi_KP, Psi_KI, Psi_KD = 14.980380812331262, 0.698851320481798, 0.340664466699192


    Theta_KP, Theta_KI, Theta_KD = 4.463314286374409, 2.996509887046771, 3.944762963507762
    Psi_KP, Psi_KI, Psi_KD = 9.531628038854562, 2.573424897658662, 0.134984100963076
    ...
    for i in range(num_samples):
        ...
        z_des, phi_des, theta_des, psi_des, z_dot_des, phi_dot_des, theta_dot_des, psi_dot_des = reference_generator(
            sim_time, initial_Z, initial_phi, initial_theta, initial_psi, Ts, signal=1)
        #
        ### ----------------- Adaptive PID Part 1 --------------- ###
