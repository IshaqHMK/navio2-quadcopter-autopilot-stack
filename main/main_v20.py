...
imu.initialize()
 ...
 # -------- Initialize Filters -------- #
filter_cutoff = 15.0  # Cutoff frequency in Hz
...
def main():
    ...
    for i in range(num_samples):
        ...
        phi_meas = apply_recursive_filter(phi_meas, filtered_phi, alpha, 30) # was 10
        theta_meas = apply_recursive_filter(theta_meas, filtered_theta, alpha, 50)
        psi_meas = apply_recursive_filter(psi_meas, filtered_psi, alpha, 50)
