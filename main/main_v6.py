# IH 2025
# version 6
# Note: Motor Speeds and Madwick filter
...
def main():
    ...
    for i in range(num_samples):
        ...
        # Calculate desired motor speeds (angular velocities) using motor_speed

        # Send PWM signals corresponding to the calculated angular velocities
        omega = np.array([omega_1, omega_2, omega_3, omega_4])
        send_speed_command(pwm_outputs, omega, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH)
