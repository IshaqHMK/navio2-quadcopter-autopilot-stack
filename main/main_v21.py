# IH 2025
# version 18 is the main version
# Note: copied from version 18 without Adaptive PID stuff
...
Phi_KP, Phi_KI, Phi_KD = 6, 0, 0
#Theta_KP, Theta_KI, Theta_KD = (K3**2)/(4*(1/Jy)), 0, 0
Theta_KP, Theta_KI, Theta_KD = 6, 0, 0
...
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.021, beta=0.2, frequency=1/Ts)  # chatgpt recomended  
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, beta=0.125, frequency=1/Ts)  # chatgpt recomended  
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.021, beta=0.2, frequency=1/Ts)
madgwick = Madgwick(gyr=m9g, acc=m9a, mag=m9m, gain_marg=0.15, frequency=1/Ts)
...
def main():
    ...
    for i in range(num_samples):
        ...
        # --- Apply Feedback Linearization to the rotational controls --- #
        ...
        U1 = 0 # disable altitude control for now (feedback linearization)
