...
def main():
    ...
    adaptive_phi = AdaptiveGains(initial_Kp=Phi_KP, initial_Ki=Phi_KI, initial_Kd=Phi_KD, alpha=0.01, gamma=0.9, bounds_Kp=(0,12), bounds_Ki=(0,5), bounds_Kd=(0,4))
    # adaptive_theta = AdaptiveGains(initial_Kp=Theta_KP, initial_Ki=Theta_KI, initial_Kd=Theta_KD, alpha=0.01, gamma=0.9, bounds_Kp=(0,10), bounds_Ki=(0,5), bounds_Kd=(0,5))
