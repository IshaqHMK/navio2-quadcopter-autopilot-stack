...
class AdaptiveGains:
    ...
    def __init__(
        ...
        alpha=0.1, gamma=0.1,  # alpha = learning rate, gamma = momentum
...
def main():
    ...
    for i in range(num_samples):
        ...
        phi_dot, theta_dot, psi_dot = euler_angle_rates(p_meas, q_meas, r_meas, phi_meas, theta_meas)
        ...
        if i > 0:
            ...
            Phi_KP, Phi_KI, Phi_KD = adaptive_phi.update(
                ...
                measured_rate=phi_dot  # Measured  rate   
            )
            ...
            Theta_KP, Theta_KI, Theta_KD = adaptive_theta.update(
                ...
                measured_rate=theta_dot  # Measured  rate  
            )
            ...
            Psi_KP, Psi_KI, Psi_KD = adaptive_psi.update(
                ...
                measured_rate=psi_dot  # Measured  rate 
            )
        # ------------- Adaptive GD PID Part 1 - end ----------------- #

        #Phi_KP, Phi_KI, Phi_KD = 3, 2.5, 7 # 
        #Theta_KP, Theta_KI, Theta_KD = 3, 3 , 4.75
        #Phi_KP, Phi_KI, Phi_KD = 6, 1, 4 # 
        #Theta_KP, Theta_KI, Theta_KD =4, 1 , 4
        #Psi_KP, Psi_KI, Psi_KD = 5, 3, 4
