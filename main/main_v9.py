# IH 2025
# version 9
# Note: Added CPU and PWM Idle (Worked)
...
KT = 0.000021;    # Thrust force coeffecient (N m / (rad/s)^2) (T-motor 12 inch prop)
Kd = l*KT # 1.3858e-6;    # Drag torque coeffecient (N/(rad/s)^2 ) 
max_motor_speed_rpm = 5027  # rpm ~~ 14.8V x [ ] rpm/V
