# IH 2025
# version 3
# Note: organized saving: data_processing.py, matfile_utils.py (new files)
...
def main():
    ...
    for i in range(num_samples):
        ...
        # --------------------------------------------------------------- #
        # 7. Inside the loop, populate `storage` dictionary as needed
