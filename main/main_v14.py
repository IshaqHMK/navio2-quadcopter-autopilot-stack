...
Theta_KP, Theta_KI, Theta_KD = 1, 1, 1  
Phi_KP, Phi_KI, Phi_KD = 4.0, 1, 2
Psi_KP, Psi_KI, Psi_KD = 0, 0, 0.0
...
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.05, beta=0.1, frequency=1/Ts)  # Adjust parameters here
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.041, beta=0.08, frequency=1/Ts)  # chatgpt recomended
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.020, beta=1.2077, frequency=1/Ts)  # chatgpt recomended  
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.020, beta=0.320, frequency=1/Ts)  # chatgpt recomended  
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.020, beta=0.2, frequency=1/Ts)  # chatgpt recomended  
