...
Phi_KP, Phi_KI, Phi_KD = 1.1, 0.5, 1
Theta_KP, Theta_KI, Theta_KD = 1, 0.5, 1
...
# madgwick = Madgwick(gyr=m9g, acc=m9a, mag = m9m, gain=0.03, beta=0.25, frequency=1/Ts)  # chatgpt recomended  
